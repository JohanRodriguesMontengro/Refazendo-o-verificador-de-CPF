...
do {
  ...
  if (isNaN(CpfClient) || CpfClient.length !== 11 || CpfClient === FalseCpfKnown) {
...
let FirstNumberCheck = parseInt(CpfClient[0]) * 10 + parseInt(CpfOfClient[1]) * 9 + parseInt(CpfOfClient[2]) * 8 + parseInt(CpfOfClient[3]) * 7 + parseInt(CpfOfClient[4]) * 6 + parseInt(CpfOfClient[5]) * 5 + parseInt(CpfOfClient[6]) * 4 + parseInt(CpfOfClient[7]) * 3 + parseInt(CpfOfClient[8]) * 2
let FirstCalculation = FirstNumberCheck * 10 % 11

FirstCalculation = FirstCalculation >= 10 ? FirstCalculation = 0 : FirstCalculation = FirstNumberCheck * 10 % 11

let SecondNumberCheck = parseInt(CpfOfClient[0]) * 11 + parseInt(CpfOfClient[1]) * 10 +parseInt(CpfOfClient[2]) * 9 + parseInt(CpfOfClient[3])* 8 +parseInt(CpfOfClient[4]) * 7 + parseInt(CpfOfClient[5])* 6 +parseInt(CpfOfClient[6]) * 5 + parseInt(CpfOfClient[7])* 4 + parseInt(CpfOfClient[8]) * 3 + FirstCalculation * 2
